...
Wir betrachten die beiden Fälle $1 \leq p < \infty$ und $p = \infty$ getrennt. Zunächst betrachten wir den Fall $1 \leq p < \infty$.
...
\[
 ...
 \leq \|f_k-f\|_p \|g\|_{p'}.
\]
Da $f_k \longrightarrow f$ in $L^p(\Omega)$ ist $\limes{k}{\infty} \|f_k -f\|_p = 0$, also auch
\[
