...
Betrachtet man zwei Mengen $A$ und $A'$ mit $A = B_1\ \dcup\ B_2$ und $A' = B'_1\ \dcup\ B'_2$, so ist es einfach so sehen, dass
\[
A \times A' = B_1 \times B'_1\ \dcup\ B_1 \times B'_2\ \dcup\ B_2 \times B'_1\ \dcup\ B_2 \times B'_2.
\]
